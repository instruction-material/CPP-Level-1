...
void printLargestValue(const Grid& grid) {
    ...
    std::cout << "Largest value: " << largest << " at row " << largestRow
              << ", column " << largestCol << std::endl;
}

int main() {
    const Grid scores = {
        {8, 4, 7, 9}, {6, 5, 3, 2}, {10, 1, 8, 4}, {7, 6, 2, 5}};
    ...
    std::cout << "Main diagonal total: " << mainDiagonalTotal(scores)
              << std::endl;

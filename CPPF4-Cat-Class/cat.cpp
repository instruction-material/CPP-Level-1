...
std::string Cat::toString() {
    ...
    std::string numYears = myAge > 1 ? std::to_string(myAge) + " years"
                                     : std::to_string(myAge) + " year";

    return ("Hello human, my name is " + myName + ". I am a " + myBreed +
            " breed of cat. I am currently a " + std::to_string(myAge) +
            " year old cat. I am colored " + myColor + ".");
}

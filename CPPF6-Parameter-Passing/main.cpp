...
int main() {
    ...
    int twoVal1 = 10;
    int twoVal2 = 10;
    std::cout << "\nSum of two integers passed by value: "
              << addTwoVals(twoVal1, twoVal2) << std::endl;
    std::cout
        << "The two integers after going through the function: \ntwoVal1: "
    ...
    int twoVal3 = 10;
    int twoVal4 = 10;
    std::cout << "\nSum of two integers passed by reference: "
              << addTwoValsRef(twoVal3, twoVal4) << std::endl;
    std::cout
        << "The two integers after going through the function: \ntwoVal3: "

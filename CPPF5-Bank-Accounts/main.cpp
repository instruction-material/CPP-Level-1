...
int main() {
  ...
  if (numTransactions < 0) {
    std::cout << "Please enter a non-negative number of transactions." << std::endl;
    return 1;
  }
  ...
  std::cout << "You have a balance of $" << calcTotalBalance(amounts) << " in your account at this time. Thank you!" << std::endl;
  return 0;
}
